...
- 5 входных каналов с разломами: + Faults(1)
- Размер изображений: 512×1248 (после паддинга)
...
- Добавлен новый канал `closedIsolines` для улучшения детектирования замкнутых ловушек
- Поддержка двух источников данных: `cps_tiles` и `png`
- Обновленная архитектура с 6/7 входными каналами для cps_tiles
